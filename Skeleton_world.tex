...
\begin{itemize}
\item sprinkle evocative details everywhere 
\item make the world seem real
\item name everyone, make everyone human
\item build a bigger world through play
\item create interesting dilemmas not interesting plots
\item address yourself to the characters not players
\item be a fan of the players characters
\item destroy your creations, don't protect them.
...
\item sometimes, reflect a question back upon the players 
\item think off screen too
...
\section{GM moves}
\begin{itemize}
\item give them a difficult decision to make
\item tell them the possible consequences and ask
\item Use a front or threat move
\item Offer an opportunity, with or without a cost
\item Turn a failed move back on them
\item Offer Stuff that's painfully expensive but good
\item Put the spotlight on someone
\item seperate them
\item Put them together 
\item make thier lives complicated now
\item use up their resources 
\item activate stuff's bad side
\item + Additional from the theme (see Theme Deconstruction section)
\end{itemize}
